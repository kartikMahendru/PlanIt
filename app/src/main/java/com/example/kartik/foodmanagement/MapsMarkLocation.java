...
public class MapsMarkLocation extends FragmentActivity implements OnMapReadyCallback, GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener, ResultCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonConfirm.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent=new Intent(MapsMarkLocation.this,UploadActivity.class);
...
//		mMap.setMapType(GoogleMap.MAP_TYPE_HYBRID);
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        else if (resultCode == MapsMarkLocation.RESULT_OK && requestCode == REQUEST_CODE_AUTOCOMPLETE) {
    ...
    private void getDeviceLocation() {
        mFusedLocationProviderClient.getLastLocation().addOnCompleteListener(new OnCompleteListener<Location>() {
            ...
            public void onComplete(@NonNull Task<Location> task) {
                ...
                {
                    Toast.makeText(MapsMarkLocation.this,"Unable to get Last Location",Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
